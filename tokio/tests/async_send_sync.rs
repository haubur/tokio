...
async_assert_fn!(tokio::sync::Semaphore::acquire_many(_, usize): Send & Sync & !Unpin);
async_assert_fn!(tokio::sync::Semaphore::acquire_many_owned(_, usize): Send & Sync & !Unpin);
